...
TItem::TItem(QPointF atScenePos, QRectF bounDingRect, QPen pen, QBrush brush) : QGraphicsItem()
{
...
void TItem::mouseMoveEvent(QGraphicsSceneMouseEvent *event)
{
    ...
    if(mDropScale)
    {
        QPointF dis = event->pos() - mDropPos;
        mDropPos = event->pos();
