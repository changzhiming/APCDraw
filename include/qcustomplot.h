...
class QCP_LIB_DECL QCustomPlot : public QObject
{
  Q_OBJECT
  /// \cond INCLUDE_QPROPERTIES
...
public:
  ...
  */
  ...
  explicit QCustomPlot(QSize size = QSize(100, 100), QObject * parent = 0);
  virtual ~QCustomPlot();
  ...
  QLocale locale(){return this->mLoacal;}
  void setLocale(QLocale mLocal){ mLoacal= mLocal; }
