...
public:
    ...
    inline static QSqlDatabase getDb(const QString &connectName) { return QSqlDatabase::database(connectName, true); }
    inline static void removeDbCon(const QString &connectName) { QSqlDatabase::removeDatabase(connectName); }
    static QList<QStringList> getAllDbInfo();
    static bool execSql(const QString &connectName, const QString &sql);
    static bool execSql(const QString &connectName, const QString &sql, const QByteArray &data);
