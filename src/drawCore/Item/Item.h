...
class TItem : public QGraphicsObject
{
    Q_OBJECT
...
public:
    ...
    inline QRectF fGetBoundingRect() const;

    inline void fSetBrush(const QBrush &brush);
    inline QBrush fGetBrush() const;

    inline void fSetPen(const QPen &pen);
    inline QPen fGetPen() const;
    inline void fUpdate();
...
inline double TItem::fGetZValue() const
{
    return zValue();
}
...
inline QRectF TItem::fGetBoundingRect() const
{
...
inline QBrush TItem::fGetBrush() const
{
     return m_Brush;
}
...
inline QPen TItem::fGetPen() const
{
    return m_Pen;
}
